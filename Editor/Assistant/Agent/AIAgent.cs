namespace HT.Framework.AI
{
    ...
    public abstract class AIAgent
    {
        ...
        /// 智能体的@提及列表
        /// </summary>
        public abstract string[] Ats { get; }
        ...
        /// <param name="at">@提及</param>
        /// <param name="agentReply">智能体回复（智能体处理当前指令时可能会多次回复，参数1：当前指令是否处理完毕，参数2：回复文本内容）</param>
        public abstract void SendInstruction(string content, string code, string folderPath, string at, HTFAction<bool, string> agentReply);
    }
}